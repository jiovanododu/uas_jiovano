...
class _FormWidgetState extends State<Uas> {
  TextEditingController nameController = TextEditingController(text: 'jiovano');
  TextEditingController kelasController = TextEditingController(text: 'A');
  TextEditingController alamatController = TextEditingController(text: 'Boras');
  TextEditingController tanggalLahirController = TextEditingController(text: 'Boras,17-April-2004');
  File? photo;
